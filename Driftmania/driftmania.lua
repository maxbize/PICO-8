...
local map_road_data = {
  ...
  "0|U1h144s1T10EU1Y116X1T10Di113?1G113f10D611291B1H1;112810D611281026112810D611281026112810DW112Z1026112810E6181036112810E6181036112810E6181036112810DI111o1036112810=314611M1N1036112810=F1@6p1N1046112810J6112810J6112810JW112Z10:I1510?61810;61810?61810;61810>U1V1810;61810=U1Y111Z10;61810<U1Y111Z10<F1A10<i111Z10K61810B3147J10161810BW1@5G111810161810HH1;1C1⬆️1=1810IW1@1ˇ1@1Z10W", -- D4.tmx road
...
local map_decals_data = {
  ...
  "0か\n10Kみ1む1■10Kら1り1⁙10l⁘1‖10LL1◀10Fの1K10L▶1「10QI40♥⁘1‖10LL1◀10wほ1」10M¥10j•1、10L•1、10LI20n。1゛103:104410C¥104:104410KB1゜1910L 10Y", -- D4.tmx decals
...
local map_props_data = {
  ...
  "0^1126310E116106:1310C116101E1★1⧗2⬆️1D101:1310B4101E1ˇ1>102?1\\1D101410B4101{1|10171O101{1|101410B4101{1|1014201∧1❎101410B4101}1~1014201|1{101410BC1D102E1F14101▤1▥101410CM102X1014104410C410241014104410CY10241014104410;1126Z1>10241014104410;41091161014101あ1い101410;41081161024101|1{101410;:12861034101▤1▥101410H41044109;121310<C1D102E1F108A1>101410=M102X1094102410=410241094102410<11610241094102410;116102E1F1094102410:116102E1I10:4102410:4102E1I10;:122611128<14102X10@4108?1◆102410@C1D1084102410AR125O102う102410GC1D103E1F10HR123U109", -- D4.tmx props
...
local map_settings_data = parse_table_arr(--[[member]]"name,req_medals,laps,size,spawn_x,spawn_y,spawn_dir,bronze,silver,gold,plat",
  ...
  "|a3,2,3,30,208,624,0.0,3144,2580,2226,2130" .. -- A3.tmx settings
  "|a4,3,3,30,264,360,0.25,3846,2652,2193,2043" .. -- A4.tmx settings
  "|b1,8,4,30,432,312,0.25,4296,3450,2706,2430" .. -- B1.tmx settings
  "|b2,10,3,30,192,136,0.375,4080,2726,2358,2214" .. -- B2.tmx settings
  "|b3,12,2,30,552,264,0.25,3084,2328,1896,1743" .. -- B3.tmx settings
  "|b4,14,4,30,192,248,0.125,3489,2706,2256,1978" .. -- B4.tmx settings
  "|c1,20,3,30,232,328,0.625,4269,3186,2742,2400" .. -- C1.tmx settings
  "|c2,22,2,30,600,648,0.5,3483,2580,2232,2025" .. -- C2.tmx settings
  "|c3,24,2,30,288,208,0.75,3666,2691,2169,2013" .. -- C3.tmx settings
  "|d1,30,4,30,288,528,0.5,3837,2886,2370,2181" .. -- D1.tmx settings
  "|d2,32,4,30,352,344,0.125,3720,2460,2154,1956" .. -- D2.tmx settings
  "|d3,34,3,30,384,264,0.75,3600,3012,2691,2610" .. -- D3.tmx settings
  "|d4,36,3,30,360,624,0.5,2526,2325,2103,1950" .. -- D4.tmx settings
...
function load_level(start)
  ...
  map_prop_chunks, map_prop_tiles = load_map(map_props_data[level_index], 343, map_settings.size) -- global props_offset
...
-- Table of chunk index -> color. Color 0 == nothing. Note: automated by mapPacker
  local solid_chunks = parse_hash_map('0,0,1,5,2,3,102,0,103,10,104,12,343,0') -- global solid_chunks
