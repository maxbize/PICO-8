...
local map_settings_data = parse_table_arr("name,req_medals,laps,size,spawn_x,spawn_y,spawn_dir,bronze,silver,gold,plat",
  ...
  "|wip,0,4,30,152,48,0.75,4200,2880,2580,2430" .. -- WIP1.tmx settings
  ""
)
...
local map_checkpoints_data = {
  ...
  parse_table_arr(map_checkpoints_data_header, '|149,60,1,0,21'), -- WIP1.tmx checkpoints
}
...
function load_level(start)
  ...
  map_decal_chunks, map_decal_tiles = load_map(map_decals_data[level_index], 103, map_settings.size) -- global decals_offset
  map_prop_chunks, map_prop_tiles = load_map(map_props_data[level_index], 330, map_settings.size) -- global props_offset
...
-- Table of chunk index -> color. Color 0 == nothing. Note: automated by mapPacker
  local solid_chunks = parse_hash_map('0,0,1,5,2,3,103,0,104,10,105,12,330,0') -- global solid_chunks
